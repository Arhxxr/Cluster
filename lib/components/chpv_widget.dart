...
import 'chpv_model.dart';
export 'chpv_model.dart';

class ChpvWidget extends StatefulWidget {
  const ChpvWidget({
    super.key,
    this.parameter1,
  });
  ...
  @override
  State<ChpvWidget> createState() => _ChpvWidgetState();
}

class _ChpvWidgetState extends State<ChpvWidget> {
  late ChpvModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChpvModel());
  }
