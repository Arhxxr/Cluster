...
import '/components/nousers_widget.dart';
import '/flutter_flow/chat/index.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'chat_settings_model.dart';
export 'chat_settings_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ChatsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final chatSettingsChatsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
          appBar: AppBar(
          ...
          body: SafeArea(
            ...
            child: Column(
              ...
              children: [
                        ...
                        return Container(
                          ...
                          child: Row(
                            ...
                            children: [
                                      ...
                                      ...mapToFirestore(
                                        {
                                          'requesting_groups':
                                            ...
                                            chatSettingsChatsRecord.reference
                                          ]),
                                        },
                                      ),
                                    });
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await listViewUsersRecord.userRef!.update({
                                    ...mapToFirestore(
                                      {
                                        'requesting_groups':
                                            FieldValue.arrayRemove(
                ...
                Builder(
                  builder: (context) {
                    final users = chatSettingsChatsRecord.users.toList();
                    if (users.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, usersIndex) {
                        ...
                        return Container(
                          ...
                          child: Visibility(
                            visible: chatSettingsChatsRecord.moderators
                                    .contains(usersItem) ==
                                false,
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    '${rowUsersRecord.name} has been set to moderator.',
                                                    style: TextStyle(
                                                      color:
                                                          FlutterFlowTheme.of(
                                                                  context)
