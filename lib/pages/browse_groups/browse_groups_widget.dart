...
import 'browse_groups_model.dart';
export 'browse_groups_model.dart';

class BrowseGroupsWidget extends StatefulWidget {
  const BrowseGroupsWidget({super.key});

  @override
  State<BrowseGroupsWidget> createState() => _BrowseGroupsWidgetState();
}

class _BrowseGroupsWidgetState extends State<BrowseGroupsWidget> {
  late BrowseGroupsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BrowseGroupsModel());
  }
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (valueOrDefault<bool>(
                                    currentUserDocument?.isUnivStudent, false))
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        16.0, 16.0, 0.0, 0.0),
                          ...
                          StreamBuilder<List<ChatsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ChatsRecord> mobileViewChatsRecordList =
                                  snapshot.data!;
                              return ListView.separated(
                                ...
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: mobileViewChatsRecordList.length,
                                separatorBuilder: (_, __) =>
                                    const SizedBox(height: 12.0),
                                itemBuilder: (context, mobileViewIndex) {
                                  final mobileViewChatsRecord =
                                      mobileViewChatsRecordList[
                                          mobileViewIndex];
                                  return Visibility(
                                    visible: mobileViewChatsRecord.users
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      highlightColor:
                                                          Colors.transparent,
                                                      onTap: () async {
                                                        if (mobileViewChatsRecord
                                                                .groupPrivacy ==
                                                            'Public') {
                                                          _model.userJoinGroupChat =
                                                              await FFChatManager
                                                                  .instance
                                                                  .addGroupMembers(
                                                            mobileViewChatsRecord,
                                                          ...
                                                          ScaffoldMessenger.of(
                                                            ...
                                                            SnackBar(
                                                              content: Text(
                                                                'You have requested to join ${mobileViewChatsRecord.groupChatName}.',
                                                                style:
                                                                    TextStyle(
                                                                  color: FlutterFlowTheme.of(
                                                                          context)
