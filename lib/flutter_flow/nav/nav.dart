...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'setup_1',
          path: '/setup1',
          builder: (context, params) => const Setup1Widget(),
        ),
        FFRoute(
          name: 'setup_userinfo',
          path: '/setupUserinfo',
          ...
          builder: (context, params) => SetupUserinfoWidget(
            userProfile: params.getParam(
              'userProfile',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: 'setup_univ',
          path: '/setupUniv',
          builder: (context, params) => const SetupUnivWidget(),
        ),
        FFRoute(
          name: 'setup_univ_2',
          path: '/setupUniv2',
          builder: (context, params) => SetupUniv2Widget(
            randomcode: params.getParam(
              'randomcode',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          path: '/browseGroups',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'BrowseGroups')
              : const BrowseGroupsWidget(),
        ),
        FFRoute(
          name: 'createGroup',
          path: '/createGroup',
          builder: (context, params) => const NavBarPage(
            initialPage: '',
            page: CreateGroupWidget(),
          ),
        ),
        FFRoute(
          name: 'forgotPassword',
          path: '/changePasswordCopy',
